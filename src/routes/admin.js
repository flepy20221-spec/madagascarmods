...
// Claim duravel do envio PIX pela API PIX propria do painel. Todas as instancias/admins
// disputam a mesma transicao APPROVED -> PROCESSING no Postgres antes de chamar o provedor.
  ...
  try {
    ...
    const claimed = await db.query(
      `UPDATE withdrawals
        ...
        WHERE id = $1 AND payment_method = 'pix' AND status = 'APPROVED'
